...
Con el permiso de Accesibilidad, Menu Hub muestra junto a su icono un contador monocromo del total sin leer. Solo suma números exactos expuestos por macOS; un punto sin número cuenta como cero. En **Ajustes > Elementos y grupos** puedes configurar cada elemento como Automático, Incluir siempre o No incluir.
